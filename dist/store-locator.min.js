...
*/
var storeLocator=function(){};window.storeLocator=storeLocator;storeLocator.toRad_=function(a){return a*Math.PI/180};storeLocator.Feature=function(a,b,c){this.id_=a;this.name_=b;this.img_=c.img;this.prefferedProperty_=c.prefferedProperty||"name"};storeLocator.Feature=storeLocator.Feature;storeLocator.Feature.prototype.getId=function(){return this.id_};storeLocator.Feature.prototype.getDisplayName=function(){return this.name_};storeLocator.Feature.prototype.getImage=function(){return"\x3cimg src\x3d"+this.img_+"\x3e"};
storeLocator.Feature.prototype.getPreferredProperty=function(){return"img"===this.prefferedProperty_?this.getImage():this.getDisplayName()};storeLocator.Feature.prototype.toString=function(){return this.getDisplayName()};storeLocator.FeatureSet=function(a){this.array_=[];this.hash_={};for(var b=0,c;c=arguments[b];b++)this.add(c)};storeLocator.FeatureSet=storeLocator.FeatureSet;storeLocator.FeatureSet.prototype.toggle=function(a){this.contains(a)?this.remove(a):this.add(a)};storeLocator.FeatureSet.prototype.contains=function(a){return a.getId()in this.hash_};storeLocator.FeatureSet.prototype.getById=function(a){return a in this.hash_?this.array_[this.hash_[a]]:null};
...
storeLocator.Panel.prototype.selectedStore_changed=function(){$(".highlighted",this.storeList_).removeClass("highlighted");var a=this,b=this.get("selectedStore");if(b){this.directionsTo_=b;this.storeList_.find("#store-"+b.getId()).addClass("highlighted");if(this.settings_.directions){this.directionsPanel_.find(".directions-to").val(b.getDetails().title);var c=$("\x3ca/\x3e").text("Directions").attr("href","#").addClass("action").addClass("directions");c.click(function(){a.showDirections();return!1})}var d=
a.get("view").getInfoWindow().getContent(),e=$("\x3ca/\x3e").text("Zoom here").attr("href","#").addClass("action").addClass("zoomhere"),f=$("\x3ca/\x3e").text("Street view").attr("href","#").addClass("action").addClass("streetview"),g=b.props_.website,h=b.props_.email;if(g)var k=$("\x3ca/\x3e").text("Website").attr("href","http://"+g).attr("target","_blank").addClass("action");if(h)var l=$("\x3ca/\x3e").text(h).attr("href","mailto:"+h).addClass("action");e.click(function(){a.get("view").getMap().setOptions({center:b.getLocation(),
zoom:16})});f.click(function(){var c=a.get("view").getMap().getStreetView();c.setPosition(b.getLocation());c.setVisible(!0)});$(d).append(e).append(f)&&$(d).append(c);$(d).append(k);$(d).append(l)}};storeLocator.Panel.prototype.hideDirections=function(){this.directionsVisible_=!1;this.directionsPanel_.fadeOut();this.featureFilter_.fadeIn();this.storeList_.fadeIn();this.directionsRenderer_.setMap(null)};
